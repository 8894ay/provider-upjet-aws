...
import (
	...
	"github.com/upbound/provider-aws/v2/config/cluster/apprunner"
	"github.com/upbound/provider-aws/v2/config/cluster/appstream"
	"github.com/upbound/provider-aws/v2/config/cluster/athena"
	...
	"github.com/upbound/provider-aws/v2/config/cluster/cloudsearch"
	"github.com/upbound/provider-aws/v2/config/cluster/cloudwatch"
	"github.com/upbound/provider-aws/v2/config/cluster/cloudwatchevents"
	"github.com/upbound/provider-aws/v2/config/cluster/cloudwatchlogs"
	"github.com/upbound/provider-aws/v2/config/cluster/codeartifact"
	"github.com/upbound/provider-aws/v2/config/cluster/cognitoidentity"
	"github.com/upbound/provider-aws/v2/config/cluster/cognitoidp"
	"github.com/upbound/provider-aws/v2/config/cluster/connect"
	"github.com/upbound/provider-aws/v2/config/cluster/cur"
	"github.com/upbound/provider-aws/v2/config/cluster/datasync"
	"github.com/upbound/provider-aws/v2/config/cluster/dax"
	"github.com/upbound/provider-aws/v2/config/cluster/devicefarm"
	"github.com/upbound/provider-aws/v2/config/cluster/directconnect"
	"github.com/upbound/provider-aws/v2/config/cluster/dms"
	"github.com/upbound/provider-aws/v2/config/cluster/docdb"
	"github.com/upbound/provider-aws/v2/config/cluster/ds"
	"github.com/upbound/provider-aws/v2/config/cluster/dsql"
	"github.com/upbound/provider-aws/v2/config/cluster/dynamodb"
	"github.com/upbound/provider-aws/v2/config/cluster/ebs"
	"github.com/upbound/provider-aws/v2/config/cluster/ec2"
	"github.com/upbound/provider-aws/v2/config/cluster/ecr"
	"github.com/upbound/provider-aws/v2/config/cluster/ecrpublic"
	"github.com/upbound/provider-aws/v2/config/cluster/ecs"
	"github.com/upbound/provider-aws/v2/config/cluster/efs"
	"github.com/upbound/provider-aws/v2/config/cluster/eks"
	...
	"github.com/upbound/provider-aws/v2/config/cluster/kafka"
	"github.com/upbound/provider-aws/v2/config/cluster/kafkaconnect"
	"github.com/upbound/provider-aws/v2/config/cluster/kendra"
	"github.com/upbound/provider-aws/v2/config/cluster/kinesis"
	"github.com/upbound/provider-aws/v2/config/cluster/kinesisanalytics"
	kinesisanalytics2 "github.com/upbound/provider-aws/v2/config/cluster/kinesisanalyticsv2"
	...
	"github.com/upbound/provider-aws/v2/config/cluster/mq"
	"github.com/upbound/provider-aws/v2/config/cluster/mwaa"
	...
	"github.com/upbound/provider-aws/v2/config/cluster/qldb"
	"github.com/upbound/provider-aws/v2/config/cluster/ram"
	"github.com/upbound/provider-aws/v2/config/cluster/rds"
	"github.com/upbound/provider-aws/v2/config/cluster/redshift"
	...
	"github.com/upbound/provider-aws/v2/config/cluster/servicediscovery"
	"github.com/upbound/provider-aws/v2/config/cluster/sfn"
	...
	"github.com/upbound/provider-aws/v2/config/cluster/wafv2"
)
